...
var QuizPage = (function () {
    ...
    QuizPage.prototype.getRemainingTime = function () {
        var isSingleDigitTime = this.remainingTime < 10;
        if (isSingleDigitTime) {
